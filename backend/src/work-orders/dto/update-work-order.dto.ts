...
class PurchaseDataDto {
  @ApiPropertyOptional({ description: 'Total de la venta', example: 150000 })
  @IsNumber()
  @IsOptional()
  totalVenta?: number;
  ...
  @ApiPropertyOptional({ description: 'Saldo pendiente', example: 100000 })
  @IsNumber()
  @IsOptional()
  saldo?: number;

  @ApiPropertyOptional({ description: 'Forma de pago', enum: PaymentMethod })
...
export class UpdateWorkOrderDto {
  @ApiPropertyOptional({ description: 'Tipo de orden', enum: WorkOrderType })
  ...
  @ApiPropertyOptional({ description: 'Fecha de venta', example: '2026-01-30' })
  @IsDateString()
  @IsOptional()
  fechaVenta?: string;
